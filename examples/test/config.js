...
export const requiredOptionKeys = definedOptions.filter(requiredOptions => requiredOptions.isRequired).map(requiredOptions => requiredOptions.key);
...
// get config defaults
const configDefaults = definedOptions.filter(definedOption => definedOption.defaultValue).reduce((defaults, defaultOption) => ({
    ...defaults,
