...
export class Table extends React.Component<ITableProps, ITableState> {
    ...
    public componentWillReceiveProps(nextProps: ITableProps) {
        ...
        const sortingChanged = !isEqual(sortItemsPrev, sortItemsNext) && !isEqual(this.state.sortItems, sortItemsNext);

        if (!DataSourceUtils.dataSourcesMatch(this.props.dataSource, nextProps.dataSource) || sortingChanged) {
            const sortItems = sortingChanged ? sortItemsNext : this.state.sortItems;
